...
#define MASTERNODE_MIN_CONFIRMATIONS           7    //myfix for confirm
...
//
// The Masternode Class. For managing the darksend process. It contains the input of the 50,000 ECKO, signature to prove
