...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ECKO");
    case mBTC: return QString("mECKO");
    case uBTC: return QString::fromUtf8("μECKO");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ECKOs");
    case mBTC: return QString("Milli-ECKOs (1 / 1,000)");
    case uBTC: return QString("Micro-ECKOs (1 / 1,000,000)");
    default: return QString("???");
    }
}
